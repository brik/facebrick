...
void Inbox::requestFailedWithFacebookError(const FBError &error, bool handled)
{
...
void Inbox::permissionRequestFailedWithError(const FBError &error)
{
#ifdef Q_WS_MAEMO_5
...
void Inbox::permissionGranted()
{
    qDebug() << "Permission granted";
    sender()->deleteLater();
}

void Inbox::permissionDeniedOrCancelled()
{
